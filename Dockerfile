...
# Create amero user
RUN adduser --system --group --disabled-password amero && \
	mkdir -p /wallet /home/amero/.bitamero && \
	chown -R amero:amero /home/amero/.bitamero && \
	chown -R amero:amero /wallet

# Contains the blockchain
VOLUME /home/amero/.bitamero
...
# switch to user amero
USER amero

ENTRYPOINT ["amerod", "--p2p-bind-ip=0.0.0.0", "--p2p-bind-port=18080", "--rpc-bind-ip=0.0.0.0", "--rpc-bind-port=18081", "--non-interactive", "--confirm-external-bind"]
